...
var AuthenticationContext = (function () {
		...
		window.Logging = {
			level: 0,
			log: function (message) { console.log(message); alert('a') }
		};
		...
		AuthenticationContext.prototype.login = function (loginStartPage) {
			...
			var urlNavigate = this._getNavigateUrl('id_token', null) + '&nonce=' + encodeURIComponent(this._idTokenNonce) //+ '&scope=user_impersonation&resource=https%3A%2F%2Fmanagement.azure.com%2F';
